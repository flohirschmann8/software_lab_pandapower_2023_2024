...
line6 = pp.create_line(net, bus4, bus6, length_km=0.50, std_type="NAYY 4x50 SE", name="Line 6")

#create voltage controlled generator
pp.create_gen(net, bus5, p_mw=0.1, vm_pu=1.0, name="generator")

#static generator
sgen1 = pp.create_sgen(net, bus1, p_mw=0.035, q_kvar=-5.0, name="sgen1")
sgen2 = pp.create_sgen(net, bus2, p_mw=0.002, q_kvar=-0.2, name="sgen2")
sgen3 = pp.create_sgen(net, bus3, p_mw=0.01, q_mvar=0.0, name="sgen3")
sgen4 = pp.create_sgen(net, bus6, p_mw=0.007, q_kvar=1.0, name="sgen4")
