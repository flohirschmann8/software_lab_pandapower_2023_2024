...
#Knoten der Netzbereiche listen
...
#Leitungen von area_3 mit get_connected_elements()-Funktion
lines_area3 = tool.get_connected_elements(net, "line", buses_area3)

#Trafo, sgen, load und ext_grid mit isin()-Funktion
...
#Collection für Leitungen,Knoten,Trafo, ext_grid, alles in grau
...
#Collection für Knoten, Leitungen, Trafo, ext grid area 3 in blau
...
#Plotten der Collections
plot.draw_collections([lc, bc, gc1, gc2, gc4, bc3, lc3, gc3], figsize=(8,6))
plt.show()

#Anzahl Knoten, Leitungen, Lasten und Generatoren anzeigen
